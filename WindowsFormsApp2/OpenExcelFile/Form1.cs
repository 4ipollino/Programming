...
namespace OpenExcelFile
{
    ...
    {
        ExcelObj.Application app = new ExcelObj.Application(); ExcelObj.Workbook workbook;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                ...
                string[] columnNames = new String[dt.Columns.Count]; for (int i = 0; i < dt.Columns.Count; i++)
                {
