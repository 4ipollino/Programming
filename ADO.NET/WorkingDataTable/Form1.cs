...
namespace WorkingDataTable
{
    public partial class Form1 : Form
    {
        ...
        {
            DataSet1.CustomersRow NewRow = (DataSet1.CustomersRow)NorthwindDataset.Customers.NewRow();
        ...
        private DataSet1.CustomersRow GetSelectedRow()
        {
            ...
            DataSet1.CustomersRow SelectedRow = NorthwindDataset.Customers.FindByCustomerID(SelectedCustomerID); 
            return SelectedRow;
        }
