...
namespace DataGridViewExample
{
    public partial class Form1 : Form
    {
        ...
        private void AddColumnButton_Click(object sender, EventArgs e)
        {
            ...
            customersDataGridView.CellValidating += customersDataGridView_CellValidating;
        }

        void customersDataGridView_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
